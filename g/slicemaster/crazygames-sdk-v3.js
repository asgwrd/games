...
( () => {
    var e = {
        486: function(e, t, n) {
            ...
            e = n.nmd(e),
            function() {
                var o, i = "Expected a function", a = "__lodash_hash_undefined__", u = "__lodash_placeholder__", s = 32, c = 128, l = 1 / 0, f = 9007199254740991, h = NaN, d = 4294967295, p = [["ary", c], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", 16], ["flip", 512], ["partial", s], ["partialRight", 64], ["rearg", 256]], g = "[object Arguments]", v = "[object Array]", y = "[object Boolean]", _ = "[object Date]", b = "[object Error]", m = "[object Function]", w = "[object GeneratorFunction]", k = "[object Map]", I = "[object Number]", E = "[object Object]", S = "[object Promise]", A = "[object RegExp]", P = "[object Set]", x = "[object String]", O = "[object Symbol]", T = "[object WeakMap]", M = "[object ArrayBuffer]", D = "[object DataView]", j = "[object Float32Array]", R = "[object Float64Array]", C = "[object Int8Array]", L = "[object Int16Array]", B = "[object Int32Array]", U = "[object Uint8Array]", G = "[object Uint8ClampedArray]", N = "[object Uint16Array]", z = "[object Uint32Array]", q = /\b__p \+= '';/g, F = /\b(__p \+=) '' \+/g, W = /(__e\(.*?\)|\b__t\)) \+\n'';/g, V = /&(?:amp|lt|gt|quot|#39);/g, Q = /[&<>"']/g, J = RegExp(V.source), H = RegExp(Q.source), X = /<%-([\s\S]+?)%>/g, Z = /<%([\s\S]+?)%>/g, K = /<%=([\s\S]+?)%>/g, Y = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, $ = /^\w*$/, ee = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, te = /[\\^$.*+?()[\]{}|]/g, ne = RegExp(te.source), re = /^\s+/, oe = /\s/, ie = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, ae = /\{\n\/\* \[wrapped with (.+)\] \*/, ue = /,? & /, se = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, ce = /[()=,{}\[\]\/\s]/, le = /\\(\\)?/g, fe = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, he = /\w*$/, de = /^[-+]0x[0-9a-f]+$/i, pe = /^0b[01]+$/i, ge = /^\[object .+?Constructor\]$/, ve = /^0o[0-7]+$/i, ye = /^(?:0|[1-9]\d*)$/, _e = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, be = /($^)/, me = /['\n\r\u2028\u2029\\]/g, we = "\\ud800-\\udfff", ke = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", Ie = "\\u2700-\\u27bf", Ee = "a-z\\xdf-\\xf6\\xf8-\\xff", Se = "A-Z\\xc0-\\xd6\\xd8-\\xde", Ae = "\\ufe0e\\ufe0f", Pe = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", xe = "[" + we + "]", Oe = "[" + Pe + "]", Te = "[" + ke + "]", Me = "\\d+", De = "[" + Ie + "]", je = "[" + Ee + "]", Re = "[^" + we + Pe + Me + Ie + Ee + Se + "]", Ce = "\\ud83c[\\udffb-\\udfff]", Le = "[^" + we + "]", Be = "(?:\\ud83c[\\udde6-\\uddff]){2}", Ue = "[\\ud800-\\udbff][\\udc00-\\udfff]", Ge = "[" + Se + "]", Ne = "\\u200d", ze = "(?:" + je + "|" + Re + ")", qe = "(?:" + Ge + "|" + Re + ")", Fe = "(?:['’](?:d|ll|m|re|s|t|ve))?", We = "(?:['’](?:D|LL|M|RE|S|T|VE))?", Ve = "(?:" + Te + "|" + Ce + ")?", Qe = "[" + Ae + "]?", Je = Qe + Ve + "(?:" + Ne + "(?:" + [Le, Be, Ue].join("|") + ")" + Qe + Ve + ")*", He = "(?:" + [De, Be, Ue].join("|") + ")" + Je, Xe = "(?:" + [Le + Te + "?", Te, Be, Ue, xe].join("|") + ")", Ze = RegExp("['’]", "g"), Ke = RegExp(Te, "g"), Ye = RegExp(Ce + "(?=" + Ce + ")|" + Xe + Je, "g"), $e = RegExp([Ge + "?" + je + "+" + Fe + "(?=" + [Oe, Ge, "$"].join("|") + ")", qe + "+" + We + "(?=" + [Oe, Ge + ze, "$"].join("|") + ")", Ge + "?" + ze + "+" + Fe, Ge + "+" + We, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Me, He].join("|"), "g"), et = RegExp("[" + Ne + we + ke + Ae + "]"), tt = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, nt = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], rt = -1, ot = {};
                ot[j] = ot[R] = ot[C] = ot[L] = ot[B] = ot[U] = ot[G] = ot[N] = ot[z] = !0,
                ot[g] = ot[v] = ot[M] = ot[y] = ot[D] = ot[_] = ot[b] = ot[m] = ot[k] = ot[I] = ot[E] = ot[A] = ot[P] = ot[x] = ot[T] = !1;
                var it = {};
                it[g] = it[v] = it[M] = it[D] = it[y] = it[_] = it[j] = it[R] = it[C] = it[L] = it[B] = it[k] = it[I] = it[E] = it[A] = it[P] = it[x] = it[O] = it[U] = it[G] = it[N] = it[z] = !0,
                it[b] = it[m] = it[T] = !1;
                var at = {
                    "\\": "\\",
                    "'": "'",
                ...
                var dn = Wt({
                  ...
                  , pn = function e(t) {
                    var n, r = (t = null == t ? ft : pn.defaults(ft.Object(), t, pn.pick(ft, nt))).Array, oe = t.Date, we = t.Error, ke = t.Function, Ie = t.Math, Ee = t.Object, Se = t.RegExp, Ae = t.String, Pe = t.TypeError, xe = r.prototype, Oe = ke.prototype, Te = Ee.prototype, Me = t["__core-js_shared__"], De = Oe.toString, je = Te.hasOwnProperty, Re = 0, Ce = (n = /[^.]+$/.exec(Me && Me.keys && Me.keys.IE_PROTO || "")) ? "Symbol(src)_1." + n : "", Le = Te.toString, Be = De.call(Ee), Ue = ft._, Ge = Se("^" + De.call(je).replace(te, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Ne = pt ? t.Buffer : o, ze = t.Symbol, qe = t.Uint8Array, Fe = Ne ? Ne.allocUnsafe : o, We = an(Ee.getPrototypeOf, Ee), Ve = Ee.create, Qe = Te.propertyIsEnumerable, Je = xe.splice, He = ze ? ze.isConcatSpreadable : o, Xe = ze ? ze.iterator : o, Ye = ze ? ze.toStringTag : o, et = function() {
                        try {
                            var e = ci(Ee, "defineProperty");
                            return e({}, "", {}),
                            e
                        } catch (e) {}
                    }(), at = t.clearTimeout !== ft.clearTimeout && t.clearTimeout, ct = oe && oe.now !== ft.Date.now && oe.now, lt = t.setTimeout !== ft.setTimeout && t.setTimeout, ht = Ie.ceil, dt = Ie.floor, gt = Ee.getOwnPropertySymbols, vt = Ne ? Ne.isBuffer : o, Lt = t.isFinite, Wt = xe.join, gn = an(Ee.keys, Ee), vn = Ie.max, yn = Ie.min, _n = oe.now, bn = t.parseInt, mn = Ie.random, wn = xe.reverse, kn = ci(t, "DataView"), In = ci(t, "Map"), En = ci(t, "Promise"), Sn = ci(t, "Set"), An = ci(t, "WeakMap"), Pn = ci(Ee, "create"), xn = An && new An, On = {}, Tn = Bi(kn), Mn = Bi(In), Dn = Bi(En), jn = Bi(Sn), Rn = Bi(An), Cn = ze ? ze.prototype : o, Ln = Cn ? Cn.valueOf : o, Bn = Cn ? Cn.toString : o;
                    function Un(e) {
                    ...
                    function Dr(e) {
                        return !(!$a(e) || (t = e,
                        Ce && Ce in t)) && (Za(e) ? Ge : ge).test(Bi(e));
                        var t
                    }
                    function jr(e) {
                                    ...
                                    if (l)
                                        ...
                                        if (h) {
                                            var d = Fa(c)
                                              ...
                                              , g = !d && !p && su(c);
                                            f = c,
                                            d || p || g ? Fa(s) ? f = s : Qa(s) ? f = Po(s) : p ? (h = !1,
                                            f = wo(c, !0)) : g ? (h = !1,
                                            f = Io(c, !0)) : f = [] : ru(c) || qa(c) ? (f = s,
                                            qa(s) ? f = vu(s) : $a(s) && !Za(s) || (f = pi(c))) : h = !1
                                        }
                                        h && (u.set(c, f),
                                        i(f, c, r, a, u),
                                        u.delete(c)),
                    ...
                    function Uo(e, t, n, i, a, u, s, l, f, h) {
                        ...
                        return function c() {
                            ...
                            d && f < b && (m.length = f),
                            this && this !== ft && this instanceof c && (A = _ || Co(A)),
                            A.apply(S, m)
                        }
                    }
                    function Go(e, t) {
                    ...
                    var _u = To((function(e, t) {
                      ...
                      , Iu = Jr((function(e, t) {
                        ...
                        for (i && yi(t[0], t[1], i) && (r = 1); ++n < r; )
                            for (var a = t[n], u = Mu(a), s = -1, c = u.length; ++s < c; ) {
                                var l = u[s]
                                  , f = e[l];
                    ...
                    Un.isEmpty = function(e) {
                        if (null == e)
                            return !0;
                        if (Va(e) && (Fa(e) || "string" == typeof e || "function" == typeof e.splice || Ja(e) || su(e) || qa(e)))
                            return !e.length;
                        var t = hi(e);
                        if (t == k || t == P)
                            return !e.size;
                    ...
                    Un.template = function(e, t, n) {
                        ...
                        e = yu(e),
                        t = mu({}, t, r, Zo);
                        var i, a, u = mu({}, t.imports, r.imports, Zo), s = Tu(u), c = Zt(u, s), l = 0, f = t.interpolate || be, h = "__p += '", d = Se((t.escape || be).source + "|" + f.source + "|" + (f === K ? fe : be).source + "|" + (t.evaluate || be).source + "|$", "g"), p = "//# sourceURL=" + (je.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++rt + "]") + "\n";
                        ...
                        if (g) {
                            ...
                            h = "with (obj) {\n" + h + "\n}\n";
                        h = (a ? h.replace(q, "") : h).replace(F, "$1").replace(W, "$1;"),
              ...
              , l = function() {
                ...
                e.prototype.hasAdblock = function() {
                    return r(this, void 0, void 0, (function() {
                        ...
                        return o(this, (function(t) {
                            return void 0 !== this.adblockDetectionResult ? [2, this.adblockDetectionResult] : (this.sdk.postMessage("hasAdblock", {}),
                ...
                e.prototype.handleAdBlockDetectionExecutedEvent = function(e) {
                    ...
                    if (void 0 !== this.adblockDetectionResult)
                        return this.logger.log("Received update for adblock state: (".concat(t, ").")),
        ...
        16: function(e, t, n) {
            ...
            var o = r(n(767))
              ...
              , u = function() {
                function e(e) {
                    this.sdk = e,
                    this.logger = new o.default("analytics")
                }
                return e.prototype.trackOrder = function(e, t) {
                    if (!(0,
                    i.isXsollaOrderArgumentValid)(t))
                        throw new a.AnalyticsError("invalidArgument","Order must be a JSON object.");
                    if (!a.PAYMENT_PROVIDERS.includes(e))
                        throw new a.AnalyticsError("invalidArgument","Unsupported payment provider. Supported providers: ".concat(a.PAYMENT_PROVIDERS.join(",")));
                    ...
                    return o(this, void 0, void 0, (function() {
                        ...
                        return i(this, (function(c) {
                            ...
                            case 0:
                                ...
                                window.navigator.sendBeacon(u, a) ? [3, 2] : [4, n()]) : [3, 4];
                            case 1:
                                return c.sent(),
                                [3, 3];
                            case 2:
              ...
              , h = function() {
                    ...
                    return o(this, void 0, void 0, (function() {
                        ...
                        return i(this, (function(i) {
                            ...
                            case 1:
                                ...
                                r = n.width,
                                o = n.height,
                                [4, this.prefetchResponsiveBanner({
                                    id: e,
                                    width: r,
                                    height: o
                                })];
                            case 2:
                                return a = i.sent(),
                                [2, this.renderPrefetchedBanner(a)]
                            }
                        }
                        ))
                    }
                ...
                e.prototype.prefetchResponsiveBanner = function(e) {
                    return o(this, void 0, void 0, (function() {
                        var t, n, r, o, a = this;
                        return i(this, (function(i) {
                            return this.logger.log("Prefetch responsive banner #".concat(e.id)),
                            t = e.width,
                            n = e.height,
                            r = (0,
                            l.ContainerIdToInnerId)(e.id),
                    ...
                    return o(this, void 0, void 0, (function() {
                        ...
                        return i(this, (function(o) {
                            ...
                            case 0:
                                ...
                                t = (0,
                                l.InnerIdToContainerId)(e.id),
                                this.ensureVideoAdNotPlaying(t),
                                [4, (0,
                                l.getBannerContainer)(t, !this.disableBannerCheck)];
                            case 1:
                                return o.sent(),
                                this.renderedBannerIds.add(t),
                                [2, new Promise((function(t, o) {
                                    ...
                                    i.render([a], r(r({}, e.options), {
                                        banner: {
                                            callback: function(e) {
                                                if (delete n.bannerQueue[e.code],
                                                !e.empty)
                                                    return n.logger.log("Banner rendered", u, "with options", e),
                                                ...
                                                if (n.useTestAds)
                                                    ...
                                                    n.logger.log("Fake banner rendered", u),
                                                    t();
                                                else {
                ...
                e.prototype.clearBanner = function(e) {
                    ...
                    if (t) {
                        ...
                        this.logger.log("Cleared the banner from container #".concat(e, " ").concat(n ? "(also overlay banner)" : ""))
                    } else
                        this.logger.log("There isn't a banner in container #".concat(e, ", not clearing anything."))
                }
                ,
                ...
                e.prototype.ensureVideoAdNotPlaying = function(e) {
                    if (this.sdk.ad.isAdPlaying)
                        throw new f.BannerError("videoAdPlaying","Banners cannot be rendered while a video ad is playing",e)
                }
                ,
              ...
              , l = function() {
                function e(e, t) {
                    ...
                    "local" === t.handler)
                        ...
                        this.dataHandler = new a.CloudDataHandler(e,!!t.doNotSync,t.data);
                    else {
                        if ("disabled" !== t.handler)
                            throw new o.GeneralError("unexpectedError","Unknown data handler ".concat(t.handler));
                ...
                e.prototype.debugEvent = function(e, t, n) {
                    ...
                    u.default.getInstance().sendDebugEvent("dataEventWithoutSDKPS", {
                        method: e,
                        key: t,
                        value: n
                    }, (function(e) {
            ...
            var o = n(659)
              ...
              , s = function() {
                ...
                e.prototype.gameplayStart = function() {
                    if (this.throttledGameplayStart(),
                    !this.loadStatsSent) {
                    ...
                    get: function() {
                        ...
                        return {
                            trackOrder: function(t, n) {
                                if (!(0,
                                u.isXsollaOrderArgumentValid)(n))
                                    throw new h.AnalyticsError("invalidArgument","Order must be a JSON object.");
                                if (!h.PAYMENT_PROVIDERS.includes(t))
                                    throw new h.AnalyticsError("invalidArgument","Unsupported payment provider. Supported providers: ".concat(h.PAYMENT_PROVIDERS.join(",")));
        ...
        245: function(e, t, n) {
            ...
            var l = n(951)
              ...
              , k = function() {
                function e() {
                    this.logger = new h.default("none"),
                                ...
                                return a(t, void 0, void 0, (function() {
                                    ...
                                    return u(this, (function(u) {
                                        ...
                                        case 0:
                                            ...
                                            [4, Promise.all([(0,
                                            g.checkIsCrazyGames)(), (0,
                                            g.checkIsLocalhost)()])];
                                        case 1:
                                            return t = u.sent(),
                                            o = t[0],
                                            t[1] ? (h.default.forceEnable = !0,
                                            this.sdk = new b.default,
                                            [3, 10]) : [3, 2];
                                        case 2:
                                            return o.isOnCrazyGames ? g.GF_WINDOW ? [4, Promise.all([(0,
                                            g.initSdk)(e), (0,
                                            g.fetchSdkUser)()])] : [2, r(new f.GeneralError("unexpectedError","Missing GF_WINDOW, even though running on CrazyGames"))] : [3, 9];
                                        case 3:
                                            if (i = u.sent(),
                                            a = i[0],
                                            c = i[1],
                                            null === a)
                                                throw new f.GeneralError("initFailed","The SDK failed to initialize");
                                            return this.logger.log("Init response received from GF", a),
                                            [4, (0,
                                            d.prepareInitialGameData)(c, a)];
                                        case 4:
                                            m = u.sent(),
                                            this.sdk = new y.default(a,m,c),
                                            u.label = 5;
                                        case 5:
                                        ...
                                        case 7:
                                            return k = u.sent(),
                                            (0,
                                            p.sendErrorToGf)("ads-script-load-fail", "ad", {
                                                error: (0,
                                                w.stringifyError)(k)
                                            }),
                                            this.logger.error("Failed to load ads", k),
                                            [3, 8];
                                        case 8:
                                            return [3, 10];
                                        case 9:
        ...
        951: (e, t, n) => {
            ...
            t.loadAdsIfNeeded = function(e, t) {
                return window.CrazygamesAds ? Promise.resolve() : function(e, t) {
                    return r || (r = (0,
                    o.loadScript)(e).catch((function(t) {
                        throw new Error("Error while loading script ".concat(e, ". Reason: ").concat((0,
                        i.stringifyError)(t)))
                    }
                    )).then((function() {
                        var e = window;
                        try {
                            ...
                            throw new Error("Error in initAds. Reason: ".concat((0,
                            i.stringifyError)(e)))
                        }
                    }
                    )))
        ...
        314: function(e, t, n) {
            ...
            t.renderFakeBanner = function(e) {
                ...
                if (t) {
                    ...
                    console.error("Didn't find container #".concat(e.id, " for rendering fake banner"))
            }
        },
        414: function(e, t, n) {
            "use strict";
            ...
            t.loadScript = function(e) {
                return new Promise((function(t, n) {
                    ...
                    r.onerror = function(e, t, r, i, a) {
                        try {
                            var u;
                            u = "string" == typeof e ? e : "type: ".concat(e.type, " - target: ").concat(e.currentTarget),
                            n(new Error("LoadScript error. Event [".concat(u, "]- source [").concat(t, "] - line/column [").concat(r, "/").concat(i, "] - error [").concat((0,
                            o.stringifyError)(a), "]")))
                        } catch (e) {
                            n(e)
                        }
        ...
        738: function(e, t, n) {
            ...
            var u = n(412)
              ...
              , c = n(823)
              , l = n(719)
              , f = new s.default("user")
              , h = new s.default("none");
            t.GF_WINDOW = null;
            var d = 5e3;
            t.initSdk = function(e) {
                ...
                return new Promise((function(a) {
                    var s = window.setTimeout((function() {
                        ...
                        (0,
                        c.sendErrorToGf)("gf-init-response-timeout", null, {
                            timeoutMs: d
                        }),
                        h.error("Gf Init response timeout ".concat(d, "ms")),
                        a(null)
                    }
                    ), d)
                      , l = function(e) {
                        return o(n, void 0, void 0, (function() {
                            var t;
                            return i(this, (function(n) {
                                return "initialized" === e.data.type && (h.verbose("Received init from GF", e.data),
            ...
            t.fetchSdkUser = function() {
                ...
                return new Promise((function(t) {
                    var n = window.setTimeout((function() {
                        ...
                        (0,
                        c.sendErrorToGf)("gf-user-response-timeout", null, {
                            timeoutMs: p
                        }),
                        h.error("Gf user response timeout ".concat(p, 'ms, continuing with "null" (signed out) user')),
                        t(null)
                    }
                    ), p)
                      , r = function(a) {
                        return o(e, void 0, void 0, (function() {
                            var e, o;
                            return i(this, (function(i) {
                                return "initialUserSet" === a.data.type && (f.verbose("Received initial user from GF", a.data),
                ...
                return o(this, void 0, void 0, (function() {
                    ...
                    return i(this, (function(t) {
                        ...
                        case 0:
                            ...
                            )) ? [2, !1] : (e = ["localhost", "127.0.0.1", "preview.construct.net"].includes(window.location.hostname) || "true" === (0,
                            c.getQueryStringValue)("useLocalSdk")) ? [4, (0,
                            l.wait)(500)] : [3, 2];
                        case 1:
                            t.sent(),
                            t.label = 2;
                ...
                return o(this, void 0, void 0, (function() {
                    ...
                    return i(this, (function(f) {
                        ...
                        case 0:
                            ...
                            a = function(r) {
                                var o;
                                "crazyGamesGFConfirmation" === (null === (o = null == r ? void 0 : r.data) || void 0 === o ? void 0 : o.type) && (t.GF_WINDOW = r.source,
                                n = !0,
                                e())
                            }
                            ,
