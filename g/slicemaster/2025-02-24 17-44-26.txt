...
Input.prototype.update = function(o) {
    if (MyButton.deactivateTimer > 0 && (MyButton.deactivateTimer -= o,
...
FullscreenImage.prototype.initialize = function() {
    ...
    this.previousReferenceResolution = this.screenComponent.referenceResolution.clone(),
    this.updateSize(),
...
FullscreenImage.prototype.update = function(e) {
    this.screenComponent.referenceResolution.equals(this.previousReferenceResolution) || (this.previousReferenceResolution.copy(this.screenComponent.referenceResolution),
    this.updateSize())
}
;
...
Game.prototype.initialize = function() {
    ...
    Input.mouseDis = !0,
    Game.testAPI ? (this.currLevel = 2,
    this.initialize2()) : initializeGame()
}
,
...
Game.prototype.loadLevel = function() {
    ...
    var t, a = Knife.instance.entity.getPosition();
    ...
    for (var n = 0; n < this.finish.children.length; n++)
        (t = this.finish.children[n]).script && t.script.collBox && t.script.collBox.init();
...
Game.prototype.addLevel = function(e) {
    ...
    0 == this.addedLevelsCount)
        ...
        for (var h, d, c = 0; c < t.children.length; c++)
            if ((h = t.children[c]).enabled && "Ground" == h.name) {
                var m = h.getPosition();
                (d = m.y + h.getLocalScale().y / 2) > this.levelUpperPlank && (this.levelUpperPlank = d),
    ...
    for (c = 0; c < t.children.length; c++)
        (h = t.children[c]).script && h.script.stackCreator && h.script.stackCreator.init();
...
Game.prototype.onLevelCompleted = function(e) {
    ...
    Game.goBonus = e,
    null != Game.instance.bonusOperator ? (50 == Game.instance.bonusMultiplier && sdkHandler && sdkHandler.celebrateHappyTime(),
    ...
    sdkHandler && sdkHandler.gameplayStop(),
    Game.goBonus ? FadeScreen.instance.show(.3, 2, 0, (function() {
...
Knife.prototype.stuck = function(t=!1) {
    ...
    this.lastStuckPos || (this.lastStuckPos = new pc.Vec3,
    this.lastStuckAngles = new pc.Vec3(0,0,0)),
    (!this.bladeC.checkIfUnderLine(2) && !this.bodyC.checkIfUnderLine(2) || t) && (this.lastStuckPos.copy(this.entity.getLocalPosition()),
...
Knife.prototype.onBladeTriggerEnter = function(t) {
    ...
    if (e.tags.has("ground") && 1 == this.state) {
        ...
        this.ground = t),
        e.tags.has("finish")) {
            var i, s = FinishController.instance.getBlockData(e);
            s && s.count > 1 && (s = FinishController.instance.findBlockByPosition(this.stickPoint.getPosition())),
            s ? (i = s.entity,
            Game.instance.bonusOperator = FinishController.instance.getBlockOperator(s.entity)) : (i = e,
            Game.instance.bonusOperator = null);
            var n = !1;
            Game.instance.bonusMultiplier = 1,
            Game.instance.bonusOperator && s && (Game.instance.bonusMultiplier = s.count),
            Game.instance.bonusOperator ? 50 == s.count && Game.instance.bonusReady ? (GameAudio.play("bonushit"),
            n = !0) : GameAudio.play("xhit") : GameAudio.play("finishhit"),
            s && console.log(s),
            console.log(n),
    ...
    if (e.tags.has("sliceable")) {
        ...
        var l = 0;
        a.complexSlice && (l = (this.bladeC.pos.z - t.pos.z) / t.zSize + .5),
        a.slice(l),
        this.sliceCd = .1,
...
Knife.prototype.update = function(t) {
    ...
    if (this.jumpCd > 0)
        this.jumpCd -= t;
    else if (Game.instance.controlsEnabled && !Input.mouseDis && (Input.mousePressed && e > .1 && Game.state == Game.STATE_PLAYING || Input.mousePressed && e > .1 && Input.mouseX > 0 && Game.state == Game.STATE_INTRO || this.app.keyboard.wasPressed(pc.KEY_SPACE) && (Game.state == Game.STATE_INTRO || Game.state == Game.STATE_PLAYING))) {
        this.jumpCd = .15,
    ...
    for (var s = .3333333333333333 * t, n = 0; n < 3; n++) {
        if (1 == this.state) {
...
Sliceable.prototype.slice = function(t) {
    ...
    s.applyTorque(45, 0, 0));
    var l, n = this.entity.getPosition(), r = "+" + this.price.toString() + " $", c = .8;
    ...
    this.emitId >= 0 && this.emitCount > 0) {
        ...
        for (var h = 0; h < this.emitCount; h++)
            this.emitRadius > 0 ? (Sliceable.temp.copy(n),
            ...
            EffectDrop.create(n, pc.math.random(.3, .5), Sliceable.temp2, this.emitId, this.emitColor))
    }
}
;
...
FinishController.prototype.setBestBlockType = function() {
    for (var t, e, o = 0; o < FinishController.blockData.length && 50 != (t = FinishController.blockData[o]).count; o++)
        ;
    var r, l, i = FinishController.blockData[0].blockType, a = this.applyOperatorData(100, i);
    ...
    for (o = 1; o < FinishController.blockData.length; o++)
        ...
        i = l,
        e = FinishController.blockData[o]);
    l = t.blockType,
...
FinishController.prototype.placeBlocks2 = function(t) {
    ...
    for (var i, a, n = 0, s = 0; s < this.blocks.length; s++) {
        ...
        for (var p = 0; p < FinishController.blockData.length; p++)
            ...
            l == e.entity && (e.blockType = this.blockTypes[n],
            n++)
    }
    ...
    for (p = 0; p < FinishController.blockData.length; p++)
        ...
        o.y += .5 * e.sizeY;
    t ? (i.text.element.text = "BONUS!",
    i.text.script.scaler.enabled = !0) : (i.text.script.scaler.enabled = !1,
    i.text.setLocalScale(.01, .01, .01)),
    o.y += .5 * this.lastBlockSizeY,
...
FinishController.prototype.generateRandomBlockData2 = function() {
    ...
    this.blockTypes.push(this.createBlock(OperatorType.MULTIPLY)),
    this.blockTypes.push(this.createBlock(OperatorType.ADD));
    var t, e = this.getRandomNegativeOperator();
...
FinishController.prototype.createBlock = function(t) {
    ...
    t == OperatorType.ADD && Math.random() < .8 && this.getRandomCount(10, 100);
    ...
    return r.weight = this.applyOperatorData(100, r),
    r
}
,
...
FinishController.prototype.beautifyNumber = function(t, e) {
    ...
    if (t < 5)
        ...
        o = e == OperatorType.ADD || e == OperatorType.SUBTRACT ? [5, 10][Math.floor(2 * Math.random())] : t;
    else if (t <= 100) {
...
FinishController.prototype.applyOperatorData = function(t, e) {
    var o = t;
    return e.operator == OperatorType.MULTIPLY ? o *= e.value : e.operator == OperatorType.DIVIDE ? o /= e.value : e.operator == OperatorType.ADD ? o += e.value : e.operator == OperatorType.SUBTRACT && (o -= e.value),
    Math.round(o)
}
,
FinishController.prototype.generateBlockText = function(t, e) {
    var o = "";
    return e == OperatorType.MULTIPLY ? o = "x " + t.toString() : e == OperatorType.DIVIDE ? o = "÷ " + t.toString() : e == OperatorType.ADD ? o = "+ " + t.toString() : e == OperatorType.SUBTRACT && (o = "- " + t.toString()),
    o
}
,
FinishController.prototype.initialize = function() {
    FinishController.instance = this;
    for (var t, e, o = [2, 3, 5, 10, 25, 50], r = 0; r < this.blocks.length; r++)
...
FinishController.prototype.getBlockData = function(t) {
    for (var e, o = 0; o < FinishController.blockData.length; o++)
        if ((e = FinishController.blockData[o]).entity == t)
            return e;
    return null
}
,
...
FinishController.prototype.showFlag = function() {
    setTimeout((function() {
        ...
        for (var t = FinishController.instance.entity.getPosition(), e = 0; e < 59; e++)
            Serpantine.create(t)
    }
    ), 500),
...
ShopController.createSkin = function(t, e, o, n, r, l) {
    ...
    ShopController.shopItems.push(i),
...
ShopController.prototype.onEnable = function() {
    ...
    window.innerHeight > window.innerWidth ? (t.referenceResolution.y = this.initialHeight + 170,
    t.resolution = new pc.Vec2(t.referenceResolution.x,t.referenceResolution.y)) : (t.referenceResolution.y = this.initialHeight,
    t.resolution = new pc.Vec2(t.referenceResolution.x,t.referenceResolution.y)),
...
UiInterface.prototype.onEnable = function() {
    var e = this.entity.screen;
    window.innerHeight > window.innerWidth ? (e.referenceResolution.y = this.initialHeight + 170,
    e.resolution = new pc.Vec2(e.referenceResolution.x,e.referenceResolution.y)) : (e.referenceResolution.y = this.initialHeight,
    e.resolution = new pc.Vec2(e.referenceResolution.x,e.referenceResolution.y)),
...
Molot.prototype.update = function(e) {
    if (this.delay > 0)
        ...
        this.swingDirection > 0 ? (this.elapsedTime += e,
        this.elapsedTime >= this.time && (this.elapsedTime = this.time,
        this.swingDirection = -1)) : (this.elapsedTime -= e,
        this.elapsedTime <= 0 && (this.elapsedTime = 0,
        this.swingDirection = 1));
        var t, i = this.elapsedTime / this.time;
        t = i < .5 ? 2 * i * i : (4 - 2 * i) * i - 1,
        this.angle = 180 * t - 90,
...
UiCompleted.prototype.onEnableCb = function() {
    var e = this.entity.screen;
    for (window.innerHeight > window.innerWidth ? (e.referenceResolution.y = this.initialHeight + 170,
    e.resolution = new pc.Vec2(e.referenceResolution.x,e.referenceResolution.y)) : (e.referenceResolution.y = this.initialHeight,
    e.resolution = new pc.Vec2(e.referenceResolution.x,e.referenceResolution.y)),
    console.log(e.referenceResolution.y),
    ...
    Game.instance.bestScore < Game.instance.totalEarned && (Game.instance.bestScore = Game.instance.totalEarned); this.serps.length > 0; ) {
...
UiCompleted.prototype.update = function(e) {
    if (this.countingTotal && (this.total.script.counterText.shownValue > this.prevBestScore && (this.countingTotalResultBest || (this.total.element.color = this.bonusColors[1],
    this.totalUpper.element.color = this.bonusColors[1],
    this.countingTotalResultBest = !0)),
    this.countingTotalResultBest && (this.best.element.text = this.total.script.counterText.shownValue.toString())),
    this.counterId > 3)
        return 1;
    this.counterTimer += e,
    ...
    this.earned.script.counterText.changingSpeed = 3 * Game.instance.moneyEarned) : 2 == this.counterId || 3 == this.counterId && (this.countingTotal = !0,
...
UiGameplay.prototype.update = function(e) {
    ...
    this.l.enabled = !0,
    Game.instance.pause(!0)) : (this.alpha = 60 + e,
    this.beta--));
...
class CrazyGamesSDKHandler {
    ...
    async getUserData() {
        if (this.sdkLoaded)
            try {
                ...
                return console.log("User data:", e),
                e
            } catch (e) {
    ...
    checkEnvironment() {
        this.sdkLoaded ? console.log("Current environment:", window.CrazyGames.SDK.environment) : console.error("SDK is not initialized.")
    }
    isQATool() {
        if (this.sdkLoaded)
    ...
    async requestAd(e, a) {
        if (!this.sdkLoaded)
            return void console.error("SDK is not initialized.");
        const o = {
            adFinished: () => {
            ...
            ,
            adError: a => {
                console.log(`Error ${e} ad`, a),
                this.resumeGame()
            }
            ,
            adStarted: () => {
                console.log(`Start ${e} ad`),
                this.pauseGame()
            }
        };
    ...
    celebrateHappyTime() {
        this.sdkLoaded ? window.CrazyGames.SDK.game.happytime() : console.error("SDK is not initialized.")
    }
    startGameLoading() {
        this.sdkLoaded ? window.CrazyGames.SDK.game.loadingStart() : console.error("SDK is not initialized.")
    }
    stopGameLoading() {
        this.sdkLoaded ? window.CrazyGames.SDK.game.loadingStop() : console.error("SDK is not initialized.")
    }
}
pc.script.createLoadingScreen((function(S) {
    ...
    function setRotatingImagesContainerHeight() {
        ...
        S && (!function isPortrait() {
            return window.innerHeight > window.innerWidth
        }() ? S.style.height = .038 * window.innerHeight + "px" : S.style.height = .025 * window.innerHeight + "px")
    }
    !function dg_createHTMLElements() {
        ...
        l.style.height = .038 * window.innerHeight + "px",
